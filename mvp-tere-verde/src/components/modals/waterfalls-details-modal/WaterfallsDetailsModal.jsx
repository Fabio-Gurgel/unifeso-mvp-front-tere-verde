...
export function WaterfallsDetailsModal({ waterfall, isOpen, onClose, onViewPark, onViewTrail}) {

    const risk = RiskMap[waterfall.seguranca.risco_tromba_dagua] || {};
    const parks = parques.filter((p) => waterfall.parque_ids?.includes(p.id));
      ...
      <Modal
        ...
        leftContent={
          <div className={styles.leftContainer}>
            <Gallery
              photos={photos}
              altPrefix={`Foto da cachoeira ${waterfall.nome}.`}
            />
